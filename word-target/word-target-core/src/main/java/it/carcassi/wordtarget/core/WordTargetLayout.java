...
public class WordTargetLayout {
    ...
    private final List<List<String>> wordsInCircle = List.of(new ArrayList<String>(), new ArrayList<String>(), new ArrayList<String>(), new ArrayList<String>(), new ArrayList<String>(), new ArrayList<String>());
    private final List<List<Double>> fracsInCircle = List.of(new ArrayList<Double>(), new ArrayList<Double>(), new ArrayList<Double>(), new ArrayList<Double>(), new ArrayList<Double>(), new ArrayList<Double>());
    private final List<List<Integer>> anglesOfSeparators = List.of(new ArrayList<Integer>(), new ArrayList<Integer>(), new ArrayList<Integer>(), new ArrayList<Integer>(), new ArrayList<Integer>(), new ArrayList<Integer>());
    private final List<List<Integer>> anglesOfWords = List.of(new ArrayList<Integer>(), new ArrayList<Integer>(), new ArrayList<Integer>(), new ArrayList<Integer>(), new ArrayList<Integer>(), new ArrayList<Integer>());
    private final List<Integer> startingAngles = new ArrayList<>(List.of(0, 0, 0, 0, 0, 0));
    ...
    public void setStartingAngle(int circle, int startingAngle) {
        ...
        startingAngles.set(circle, startingAngle);
    }
    ...
    public void removeWord(String word, int circle) {
        ...
        if (!this.wordsInCircle.get(circle).contains(word)) {
            throw new IllegalArgumentException("This word is not in the list of words");
        }
